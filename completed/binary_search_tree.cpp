...
void preorder(node *root)
 ...
 node* BST_DELETE(node* root,int k)
 {
    ...
    {
        node*temp;
        if(root->left == NULL) //if any of the left,right child is NULL or both are NULL
        {
        ...
        root->data = temp->data; //replace data of node to be deleted with data of inorder successor
